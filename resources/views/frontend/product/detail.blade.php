...
@section('seo')
    ...
    <meta name="keywords" content="{{$detailProduct->description}}">
@endsection
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    @if (count($detailProduct->gallery)>0)
                                    ...
                                    @else
                                        <div class="product-slick">
                                            <div><img src="{{'upload/images/product/' . $detailProduct->image }}" alt="{{ $detailProduct->name }}"
                                    ...
                                    <div class="col-sm-12 col-lg-12">
                                        ...
                                        <div class="tab-content nav-material" id="top-tabContent">
                                            <div class="tab-pane fade show active ckeditor-content" id="top-home"
                                                ...
                                                <p><strong>{{ $detailProduct->name }}</strong></p>
                            ...
                            <div class="offer-slider">
                                @foreach ($featureProducts as $featureProduct)
                                    <div>
                                        ...
                                        <div class="media">
                                            <a
                                                href="/san-pham/{{ $featureProduct->slug_product }}.html">
                                                <img class="img-fluid blur-up lazyload"
                                                    src="{{'upload/images/thumb/' . $featureProduct->image }}"
                                                    alt="{{ $featureProduct->name }}"></a>
                                            <div class="media-body align-self-center">
                                                <a href="/san-pham/{{ $featureProduct->slug_product }}.html"
                                                    title="{{ $featureProduct->name }}">
                                                    <h6>{{ $featureProduct->name }}</h6>
                                                </a>
                                                <h4 class="text-lowercase">{{ number_format($detailProduct->price) }} đ
                                                </h4>
                                                <h4><del>{{ number_format($detailProduct->sale_off) }} đ</del></h4>
                                            </div>
                                        </div>
                            ...
                            <div class="row search-product">
                                    ...
                                    <div class="col-xl-2 col-md-4 col-sm-6">
                                        <div class="product-box">
                                            <div class="img-wrapper">
                                                ...
                                                <div class="front">
                                                    <a
                                                        href="/san-pham/{{ $relatePro->slug_product}}.html">
                                                        <img src="{{'upload/images/thumb/' . $relatePro->image }}"
                                            ...
                                            <div class="product-detail">
                                                <a href="/san-pham/{{ $relatePro->slug_product }}.html"
                                ...
                                <div class="col-xl-2 col-md-4 col-sm-6">
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="/san-pham/{{ $pro->slug_product }}.html"><img src="{{$pro->image}}" class="img-fluid blur-up lazyload bg-img"
                                                        alt=""></a>
                                            </div>
                                        </div>
                                        <div class="product-detail">
                                            <a href="/san-pham/{{ $pro->slug_product }}.html">
                                                <h4>{{$pro->name}}</h4>
                                            </a>
                                        </div>
                                    </div>   
